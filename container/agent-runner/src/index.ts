      ...
      mcpServers: {
        nanoclaw: {
          ...
          env: {
            ...
            ...(containerInput.secrets?.ZULIP_SITE ? { ZULIP_SITE: containerInput.secrets.ZULIP_SITE } : {}),
            ...(containerInput.secrets?.ZULIP_BOT_EMAIL ? { ZULIP_EMAIL: containerInput.secrets.ZULIP_BOT_EMAIL } : {}),
            ...(containerInput.secrets?.ZULIP_BOT_API_KEY ? { ZULIP_API_KEY: containerInput.secrets.ZULIP_BOT_API_KEY } : {}),
          },
        },
      },
      hooks: {
